    ...
    try {
        ...
        if ($stmt->execute()) {
            ...
            if (!empty($_FILES['product_images']['name'][0])) {
                ...
                $message .= " and " . $image_count . " image(s) uploaded";
            }
...
<body>
    <div class="sidebar" style="width: 250px;">
        <div class="text-center mb-4">
            <h4 class="brand-logo"><img src="logo.png" alt="Ebella" style="height: 40px; margin-right: 5px;">Ebella</h4>
            <p class="text-white">Management System</p>
        </div>
        <a href="dashboard.php"><i class="fas fa-home me-2"></i> Dashboard</a>
        <a href="view_users.php"><i class="fas fa-users me-2"></i> Users</a>
        <a href="view_products.php"><i class="fas fa-shopping-bag me-2"></i> Products</a>
